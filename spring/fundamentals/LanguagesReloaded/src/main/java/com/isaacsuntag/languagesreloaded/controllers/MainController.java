package com.isaacsuntag.languagesreloaded.controllers;
...
import com.isaacsuntag.languagesreloaded.services.LanguageService;
...
public class MainController {
	...
	public String getLangToEdit(Model model, @PathVariable("id") Long id, @ModelAttribute("language") Language lang) {
		Language getlang = languageService.findLangById(id);
		if(getlang == null) {
			return "redirect:/languages";
		}
